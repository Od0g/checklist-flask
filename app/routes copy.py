...
def create_sector():
    form = SectorForm()
    # Popula o campo de seleção com todos os usuários que são 'Líder'
    ...
    if form.validate_on_submit():
        ...
        # Encontra os objetos User dos líderes selecionados
...
def edit_sector(sector_id):
    ...
    if request.method == 'GET':
        # Pré-seleciona os líderes que já estão associados a este setor
    ...
    if form.validate_on_submit():
        ...
        # Limpa a lista atual e adiciona os novos líderes selecionados
